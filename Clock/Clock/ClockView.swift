...
//tells storyboard to render this view using the draw method and show it on the storyboard itself
@IBDesignable
class ClockView: UIView {
    ...
    private var seconds = Hand(width: 1.0, length: 2.4, color: .red, value: 13)
    private var minutes = Hand(width: 3.0, length: 3.2, color: .white, value: 34)
    private var hours = Hand(width: 4.0, length: 4.6, color: .white, value: 3)
...
//            //red rectangle
//            let myRect = CGRect(x: 20, y: 50, width: 140, height: 80)
//            context.addRect(myRect)
//            context.setFillColor(UIColor.red.cgColor)
//            context.fillPath()
//
//            //blue rectangle
//            let myRect2 = CGRect(x: 220, y: 250, width: 90, height: 180)
